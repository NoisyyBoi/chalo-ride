          ...
          <div className="grid grid-cols-4 gap-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#f8fafc] border rounded-2xl px-5 py-5 outline-none text-lg"
              />
            </div>
          ...
          {rides.map((ride, index) => (
            ...
            >
              ...
              <div className="text-right">
                ...
                <button className="bg-[#8b5cf6] hover:bg-[#7c3aed] transition text-white px-8 py-4 rounded-2xl font-semibold text-lg mb-3">
                  Request Ride
                </button>
