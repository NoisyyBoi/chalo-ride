      ...
      <div className="max-w-7xl mx-auto px-7">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-20">
          ...
          {howItWorks.map((item) => (
            ...
            <div
              key={item.step}
              className="relative bg-white rounded-[30px] p-6 border border-slate-200 hover:-translate-y-2 duration-300"
            >
              ...
              {/* ICON */}
              <div className="w-16 h-16 rounded-2xl bg-indigo-100 flex items-center justify-center text-xl mt-4">
                {item.icon}
              </div>
